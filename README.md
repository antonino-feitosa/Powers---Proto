...
The prototype is textual[^17] (javscript) based on the software architecture described in [^18].

The [final version](https://github.com/antonino-feitosa/Powers) should be implemenete using Unity.
